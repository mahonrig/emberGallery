<?php
	...
	if (!table_exists($db, "photos")) {
		$query = "CREATE TABLE photos (id int AUTO_INCREMENT PRIMARY KEY, title varchar(100), caption varchar(500), large_path varchar(255), medium_path varchar(255), small_path varchar(255), thumb_path varchar(255));";
		tryQuery($db, $query);
	} else {
